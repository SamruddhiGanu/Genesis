function calculateMarks() {
    ...
    var subject5MarksE = (1 - subject5Difficulty / 10) * (50) * (desiredCGPA) / 10 + 40.5 * (subject5Difficulty / 10);
    ...
    ticketHTML += "<div class='subject'><b>Graphics :</b> Endsem : " + Math.round(subject5MarksE) + "</div>";
    ticketHTML +="<div class='subject'><p>Consideration : Term work marks should be 20+ </p></div>";
    ticketHTML += "</div>";
